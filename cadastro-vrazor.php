                    ...
                    <div class="right_content">
                        ...
                        <form class="form_register" action="cadastro-lp.php" method="post">
                            ...
                            <p class="copyrigth">
                                ...
                                <br>
                                Panasonic do Brasil LTDA. – CNPJ/MF 56.991.441/0001-57 - Sede: Avenida do Café, 277,
                                <br>
                                Torre A São Paulo - SP - CEP 04311-900 - Fale conosco: www.loja.panasonic.com.br. 
                                <br>
                                Todos os preços e condições deste site são válidos apenas para compras no site.
                                <br>
                                Destacamos que os preços previstos no site prevalecem aos demais anunciados em
                                <br>
                                outros meios de comunicação e sites de buscas.
                            </p>
                        </form>
                    </div>
                </aside>
